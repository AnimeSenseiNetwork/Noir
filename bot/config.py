...
class Config(object):
    ...
    AUTH_USERS = get_config("AUTH_USERS", "-1002103913042,2036803347,6691641006")
    ...
    TG_BOT_TOKEN = get_config("TG_BOT_TOKEN", "6716504661:AAGb2FJQ4daMFcjyf_y5Zn5NwWRwTp8jTIo")
